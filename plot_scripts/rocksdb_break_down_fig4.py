...
store_keys = ['Write to Memtable', 'Write delays', 'Write Other']
transfer_keys = ['Read from blocks', 'Read from Memtable', 'Read Other']

color_list_store = ['yellow',         'cyan'      ,'salmon' ]
color_list_transfer = ['brown', 'violet', 'teal' ]
